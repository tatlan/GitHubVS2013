...
{
    public partial class Fdivisiones : Form
    {
        public Fdivisiones()
        {
            InitializeComponent();
        ...
        private void comprobacion_Click(object sender, EventArgs e)
        {
            ...
            Racional divide = r1.dividir(r2);
            Racional r3 = new Racional(n3,d3);
            resultadonumerador2.Text = divide.getNumerador().ToString();
            resultadodenominador2.Text = divide.getDenominador().ToString();

            if (r3.equivalencia(divide)==true){
                int aciertos = Convert.ToInt16(cuentaaciertos.Text) + 1;
                cuentaaciertos.Text=aciertos.ToString();
                
                
            }
            else if (r3.equivalencia(divide)==false){
